...
architecture behav of bytestrm_dwordproc is 
    ...
    "bytestrm_dwordproc,hls_ip_2018_3_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.375000,HLS_SYN_LAT=746,HLS_SYN_TPT=746,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=435,HLS_SYN_LUT=973,HLS_VERSION=2018_3_1}";
    ...
    component start_for_strm_words2bytes_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    start_for_strm_words2bytes_U0_U : component start_for_strm_words2bytes_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
