...
proc create_root_design { parentCell } {
  ...
  set strm_in_V [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 strm_in_V ]
  ...
  set strm_out_V [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 strm_out_V ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {200000000.0} \
   ] $strm_out_V
  ...
  set strm_len [ create_bd_port -dir I -from 15 -to 0 -type data strm_len ]
  set_property -dict [ list \
  ...
  set hls_inst [ create_bd_cell -type ip -vlnv xilinx.com:hls:bytestrm_dwordproc:1.0 hls_inst ]

  # Create interface connections
  connect_bd_intf_net -intf_net ap_ctrl_0_1 [get_bd_intf_ports ap_ctrl] [get_bd_intf_pins hls_inst/ap_ctrl]
  connect_bd_intf_net -intf_net hls_inst_strm_out_V [get_bd_intf_ports strm_out_V] [get_bd_intf_pins hls_inst/strm_out_V]
  connect_bd_intf_net -intf_net strm_in_V_0_1 [get_bd_intf_ports strm_in_V] [get_bd_intf_pins hls_inst/strm_in_V]
  ...
  connect_bd_net -net strm_len_0_1 [get_bd_ports strm_len] [get_bd_pins hls_inst/strm_len]
