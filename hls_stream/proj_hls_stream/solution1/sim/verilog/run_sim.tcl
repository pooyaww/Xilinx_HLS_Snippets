...
if {[file isfile bytestrm_dwordproc.autotvin.dat]} {
	file delete -force bytestrm_dwordproc.autotvin.dat
}

if {[file isfile bytestrm_dwordproc.autotvout.dat]} {
	file delete -force bytestrm_dwordproc.autotvout.dat
}
