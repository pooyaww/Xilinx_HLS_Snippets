...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.bytestrm_dwordproc.autotvin_strm_out_V.dat"
         "c.bytestrm_dwordproc.autotvin_strm_in_V.dat"
         "c.bytestrm_dwordproc.autotvin_strm_len.dat"
         "c.bytestrm_dwordproc.autotvout_strm_out_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.bytestrm_dwordproc.autotvout_strm_out_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
