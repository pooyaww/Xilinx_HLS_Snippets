...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "bytestrm_dwordproc.autotvin.dat"
	set constFileTvOut       "bytestrm_dwordproc.autotvout.dat"
	set constFileHdlTvIn     "bytestrm_dwordproc.autohdltvin.dat"
	set constFileHdlTvOut    "bytestrm_dwordproc.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
