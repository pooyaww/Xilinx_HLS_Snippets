...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.bytestrm_dwordproc_e_U0", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "strm_len", "Type" : "None", "Direction" : "I"},
			{"Name" : "strm_len_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "2", "DependentChan" : "6",
				"BlockSignal" : [
					{"Name" : "strm_len_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "strm_len_out1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "3", "DependentChan" : "7",
				"BlockSignal" : [
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Block_proc_U0", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "strm_len", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "1", "DependentChan" : "6",
				"BlockSignal" : [
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.strm_bytes2words_U0", "Parent" : "0",
		...
		"Port" : [
			...
			{"Name" : "bytestrm_len", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "1", "DependentChan" : "7",
				"BlockSignal" : [
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.strm_words2bytes_U0", "Parent" : "0",
		...
		"HasNonBlockingOperation" : "0",
		"StartSource" : "2",
		"StartFifo" : "start_for_strm_words2bytes_U0_U",
		"Port" : [
	...
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.strm_len_c_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.strm_len_c2_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.bytes_out_len_loc_c_U", "Parent" : "0"},
	...
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_Block_proc_U0_U", "Parent" : "0"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_strm_words2bytes_U0_U", "Parent" : "0"}]}
