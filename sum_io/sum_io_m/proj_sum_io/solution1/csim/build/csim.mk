...
HLS_SOURCES = ../../../../sum_io_test.c ../../../../sum_io.c
...
$(ObjDir)/sum_io_test.o: ../../../../sum_io_test.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../../sum_io_test.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -c -MMD -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/sum_io_test.d
