...
set C_modelArgMapList {[ 
	{ "Name" : "sum", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ sum_i sc_in sc_lv 32 signal 0 } 
	{ sum_i_ap_vld sc_in sc_logic 1 invld 0 } 
	{ sum_i_ap_ack sc_out sc_logic 1 inacc 0 } 
	{ sum_o sc_out sc_lv 32 signal 0 } 
	{ sum_o_ap_vld sc_out sc_logic 1 outvld 0 } 
	{ sum_o_ap_ack sc_in sc_logic 1 outacc 0 } 
	{ sum_i_blk_n sc_out sc_logic 1 signal -1 } 
	{ sum_o_blk_n sc_out sc_logic 1 signal -1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_i_blk_n", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sum_i_blk_n", "role": "default" }} , 
 	{ "name": "sum_o_blk_n", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sum_o_blk_n", "role": "default" }}  ]}
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "sum", "Type" : "HS", "Direction" : "IO",
				"BlockSignal" : [
					{"Name" : "sum_i_blk_n", "Type" : "RtlPort"},
					{"Name" : "sum_o_blk_n", "Type" : "RtlPort"}]}]}]}
