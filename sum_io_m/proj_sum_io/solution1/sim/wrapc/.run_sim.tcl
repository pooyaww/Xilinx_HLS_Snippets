...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sum_io_top.autotvin.dat"
	set constFileTvOut       "sum_io_top.autotvout.dat"
	set constFileHdlTvIn     "sum_io_top.autohdltvin.dat"
	set constFileHdlTvOut    "sum_io_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
