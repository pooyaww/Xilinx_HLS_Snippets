...
if {[file isfile sum_io_top.autotvin.dat]} {
	file delete -force sum_io_top.autotvin.dat
}

if {[file isfile sum_io_top.autotvout.dat]} {
	file delete -force sum_io_top.autotvout.dat
}
