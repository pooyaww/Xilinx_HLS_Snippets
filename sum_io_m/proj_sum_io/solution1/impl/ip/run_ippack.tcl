...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 r_a W 0x0 "Data signal of r_a" {{0 32 r_a W 0 "Bit 31 to 0 Data signal of r_a"}}} {0x18 r_b W 0x0 "Data signal of r_b" {{0 32 r_b W 0 "Bit 31 to 0 Data signal of r_b"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 1 latency 0 II x}
